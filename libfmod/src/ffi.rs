...
pub const FMOD_VERSION: c_uint = 0x00020309;
pub const FMOD_BUILDNUMBER: c_uint = 155273;
...
pub const FMOD_DSPCONNECTION_TYPE_PREALLOCATED: FMOD_DSPCONNECTION_TYPE = 4;
pub const FMOD_DSPCONNECTION_TYPE_MAX: FMOD_DSPCONNECTION_TYPE = 5;
...
pub type FMOD_DSP_ECHO_DELAYCHANGEMODE_TYPE = c_int;
...
pub type FMOD_DSP_MULTIBAND_DYNAMICS = c_int;
...
pub type FMOD_DSP_MULTIBAND_DYNAMICS_MODE_TYPE = c_int;
...
pub type FMOD_DSP_FFT_WINDOW_TYPE = c_int;
...
pub type FMOD_DSP_FFT_DOWNMIX_TYPE = c_int;
...
pub const FMOD_DEBUG_TYPE_VIRTUAL: FMOD_DEBUG_FLAGS = 0x00001000;
...
pub struct FMOD_DSP_PARAMETER_DYNAMIC_RESPONSE {
    pub numchannels: c_int,
    pub rms: [c_float; 32 as usize],
}
impl Default for FMOD_DSP_PARAMETER_DYNAMIC_RESPONSE {
    fn default() -> Self {
        unsafe { std::mem::zeroed() }
    }
}
